...
import searche from '../images/icons/search-icon-sm.png'
...
<div className="nav-wrapper fixed-top">
		<div className="container">
			<nav className="navbar navbar-toggleable-sm navbar-expand-md">
			    ...
			    <Link className="navbar-brand mx-auto" to="/#/"><img src={logo} alt='' /></Link>
			    ...
			    <div className="navbar-collapse collapse">
			        <ul className="navbar-nav nav-justified w-100 nav-fill">
						...
						<li className="nav-item" ><Link className="nav-link js-scroll-trigger" to="/search/"><img src={searche} alt=''/></Link></li>
